...
Сможем ли мы сохранить текущий темп разработки, ну или хотя бы не сильно замедлиться в процессе дальнейшей эволюции продукта, или для продолжения работы над проектом уже придется включать режим ручного кодированя ?
...
---
  ...
  },
  {
    ...
    excerpt: "Когда все тесты в TDD основаны на контрактах, разработка становится Specification-First Development. А если при этом используются ещё и инструменты искусственного интеллекта, то получается как раз SDD — Spec-Driven Development.",
