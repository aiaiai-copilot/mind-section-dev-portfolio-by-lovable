              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">I focus on modern web technologies: React, TypeScript, Node.js, Python, and PostgreSQL, always chosen based on project needs.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
